...
- <https://github.com/kazurayam/testing-htmx-with-Playwright-on-bun>
...
bunがインストール済みであると仮定します。下記のような操作でサンプルコードを実行することができるはずです。
    ...
    $ git clone https://github.com/kazurayam/testing-htmx-with-Playwright-on-bun
    Cloning into 'testing-htmx-with-Playwright-on-bun'...
    ...
    $ cd testing-htmx-with-Playwright-on-bun
    $ cd my-app
    $ pwd
    ~/tmp/testing-htmx-with-Playwright-on-bun
